...
public class CollectFragmentPresenter extends BasePresenter<CollectFragmentView>{
    ...
    public void getAllAlarm(String userId, String privilege, String page, final int type, String startTime, String endTime, String areaId, String placeTypeId,String parentId,String alarmType){
        mvpView.showLoading();
        Observable observable=null;
        if(type==1){
            observable = apiStores1.getAllAlarm(userId,privilege,page);
        }else{
            observable = apiStores1.getNeedAlarm(userId,privilege,startTime,endTime,areaId,placeTypeId,page,parentId,alarmType);
        }
